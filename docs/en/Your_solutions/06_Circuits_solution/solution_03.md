...
To solve this, we need to break the circuit down into its basic nodes (junctions) and count the resistors along each path. Every grey rectangular box represents a $5 \text{ }\Omega$ resistor.
...
**Answer:** The equivalent resistance of the circuit is **$80/21 \text{ }\Omega$**, or approximately **$3.81 \text{ }\Omega$**.
